...
// POST /api/admin/scrape-all — streams SSE progress with keepalive heartbeats
  ...
  const stream = new ReadableStream({
    async start(controller) {
      ...
      try {
        ...
        // Use batched scraping with progress + batch-start callbacks
        await scrapeAndSaveAll(
          accounts || [],
          // onProgress: fires after each individual account
          ...
          // onBatchStart: fires when a new Apify batch call begins
